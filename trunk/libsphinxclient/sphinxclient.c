//
// $Id: sphinxclient.c 2067 2009-11-13 23:23:06Z shodan $
//
...
//modify by zhaigy 2011-12-29 for TCP_NODELAY
...
//zhaigy fix bug,copy from 2.0.2beta
...
char ** sphinx_status ( sphinx_client * client, int * num_rows, int * num_cols )
{
	...
	// send query, get response
	if ( !net_simple_query ( client, buf, 4 ) )
		return NULL;
